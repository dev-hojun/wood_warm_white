			...
			<section class="product-list">	
				...
				<div>
					<div class="title-image">
						<img src="/www_images/edit_interior_title10.jpg" width="932px" height="610px" style="max-width: 100%; height: auto;">
							<div class="caption-0">
								<div>DINING ROOM</div>								
							</div>
					</div>
				...
				<div>
					<div class="hover-area">
						<img src="/www_images/table01.jpg" width="300px">
						<div class="caption">
							<p>
                                1 table + 2 chair<br>
                                natural / walnutbrown (2color)<br>
								<a href="">상세보기</a>
							</p>
						</div>
				...
				<div>
					<div class="hover-area">
						<img src="/www_images/table02.jpg" width="300px">
						<div class="caption">
							<p>
                                1 table + 3 chair + 1 bench<br>
                                walnut (1color)<br>
								<a href="">상세보기</a>
							</p>	
						</div>
				...
				<div>
					<div class="hover-area">
						<img src="/www_images/table03.jpg" width="300px">
						<div class="caption">
							<p>
                                1 table + 2 chair<br>
                                natural / walnutbrown (2color)<br>
						...
						<div class="description">
							...
							<p>
								<button type="button" class="btn btn-outline-secondary" style="font-size: 10px; padding: 3px; cursor: default; font-weight: 600;">무료배송</button>
								<button type="button" class="btn btn-outline-danger" style="font-size: 10px; padding: 3px; cursor: default; font-weight: 600;">할인판매</button>						</p>
						</div>
					</div>
                </div>
                ...
                <div>
					<div class="hover-area">
						<img src="/www_images/table04.jpg" width="300px">
						<div class="caption">
							<p>
                                1 table + 2 chair<br>
                                natural (1color)<br>
						...
						<div class="description">
							<p><br>
								<b>노블 고무나무 원목 모던 북유럽 2인 식탁 세트</b>
							</p>
                ...
                <div>
					<div class="hover-area">
						<img src="/www_images/table05.jpg" width="300px">
						<div class="caption">
							<p>
                                1 table + 2 chair + 1 bench<br>
                                natural (1color)<br>
								<a href="">상세보기</a>
							</p>	
						</div>
                ...
                <div>
					<div class="hover-area">
						<img src="/www_images/table06.jpg" width="300px">
						<div class="caption">
							<p>
                                1 table + 4 chair<br>
                                ivory / brown (2color)<br>
								<a href="">상세보기</a>
							</p>	
						</div>
